...
<html lang="en">
      ...
      <nav class="navbar navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          <div class="container d-flex align-items-stretch">
              <div class="col-3 d-flex align-items-right">
                <a class="navbar-brand" href="index.html">Bogor<span>Kayuh</span></a>
              </div>
              ...
              <div class="container">
                <div class="row d-flex align-items-center">
                  <div class="col-md-6 ftco-animate">
                    <h2 class="subheading"> Jumlah Sepeda</h2>
                    
                          <form action="#" class="subscribe-form">
                            <div class="form-group d-flex">
                              <input type="text" class="form-control" placeholder="Masukkan jumlah sepeda maks 3">
  ...
  <span class="validity"></span> -->
                  ...
                  <div class="col-md-6 pl-md-5 ftco-animate">
                    ...
                    <!-- </div> -->
                    <p><a class="btn btn-primary px-4 py-2">Durasi Pinjam</a></p>
                  </div>
                </div>
              </div>
            </section>
        ...
        <div class="row d-flex">
          ...
          <div class="col-lg-4 d-flex ftco-animate">
              ...
              <div class="text d-flex float-right d-block">
              	...
              	<div class="desc p-4">
	                <h3 class="heading mt-2"><a href="#">BMX</a></h3>
	                <p>Elite BMX Stealth BMX Bike.</p>
                </div>
              </div>
            </div>
          </div>
